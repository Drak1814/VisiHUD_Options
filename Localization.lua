...
L.None = "None"
L.Options_Desc = "oUF_Drak is a layout for Haste's oUF framework. Use this panel to configure some basic options for this layout."
...
L.None = "Nenhum"
L.Options_Desc = "oUF_Drak é um layout de quadros de unidade para oUF. Estas opções alterar algumas configurações básicas para os quadros."
